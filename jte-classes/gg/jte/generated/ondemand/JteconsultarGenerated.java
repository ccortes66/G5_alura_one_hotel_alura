...
public final class JteconsultarGenerated {
	...
	public static final int[] JTE_LINE_INFO = {0,0,1,2,3,5,5,5,11,11,11,17,17,20,21,23,41,41,42,42,43,43,43,43,43,43,43,43,43,43,43,43,44,44,45,45,57,57,60,60,60,60,60,60,64,64,77,77,77,78,78,78,79,79,79,80,80,80,88,88,96,96,98};
	public static void render(gg.jte.html.HtmlTemplateOutput jteOutput, gg.jte.html.HtmlInterceptor jteHtmlInterceptor, Usuario user, ConsultaInfoReservacion reservacion) {
		...
		jteOutput.writeContent("\n                 ");
		gg.jte.generated.ondemand.partes.JtetitulosGenerated.render(jteOutput, jteHtmlInterceptor, CookieController.getMyUsuario(), "Consultar Precio", "bi-cash-stack fs-1");
